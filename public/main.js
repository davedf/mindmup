...
MM.main = function (config) {
	...
	jQuery(function () {
		...
		jQuery('#topbar').alertWidget(alert).topbarWidget(jQuery('body')).mapToolbarWidget(mapModel);
		...
		jQuery('#floating-toolbar').floatingToolbarWidget(mapRepository, pngExporter, jQuery('body'));
