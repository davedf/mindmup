...
describe("Freemind Export", function () {
	...
	it('converts a single node map into a MAP/NODE XML element in freemind format', function () {
		...
		expect(MM.freemindExport(idea)).toBe('<map version="0.7.1"><node ID="1" TEXT="Root Node"></node></map>');
	});
	it('converts double quotes, > and < to XML entity in node titles', function () {
		var idea = content({id: 1, title: 'Text"<>"<>More'});
		expect(MM.freemindExport(idea)).toBe('<map version="0.7.1"><node ID="1" TEXT="Text&quot;&lt;&gt;&quot;&lt;&gt;More"></node></map>');
	});
